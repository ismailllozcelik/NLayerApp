...
namespace NLayer.Service.Services
{
    public class CategoryService : Service<Category>, ICategoryService
    {
        ...
        public CategoryService(IGenericRepository<Category> repository, IUnifOfWork unifOfWork, ICategoryRepository categoryRepository, IMapper mapper) : base(repository, unifOfWork)
        {
